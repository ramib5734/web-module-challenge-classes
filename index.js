...
// console.log(rebecca.toString());
// console.log(rebecca.eat('Bacon'))
// console.log(rebecca.stomach);
...
class Car {
  ...
  drive(distance){
    const milesDrivable = this.tank * this.milesPerGallon;
    if(milesDrivable >= distance){
...
class Student extends Lambdasian{
  ...
  listSubjects(){
    let subjects = '';
    this.favSubjects.forEach(combine => {
      subjects = subjects + combine;
    })
    return subjects;
  }
